...
const slider_load = () => {
    const newLocal = 0;
    setTimeout(() => {
        header.style.background = "url('img/fighter.jpg') no-repeat center center/cover";
        header_dur.innerText = "2h 46min";
        header_gen.innerHTML = `<i class="fas fa-star"></i>6.5
        <span>Action / Adventure </span>`;
        header_title.innerText = "Fighter";
        header_pra.innerText = "From Wikipedia, Fighter is a 2024 Indian Hindi-language action film directed by Siddharth Anand, based on a story he wrote with Ramon Chibb. Produced under Viacom18 Studios and Marflix Pictures, the film stars Hrithik Roshan, Deepika Padukone and Anil Kapoor, and serves as the first installment in a planned aerial action franchis";
    ...
    setTimeout(() => {
        header.style.background = "url('img/aquaman.webp') no-repeat center center/cover";
        header_dur.innerText = "2h 4min";
        header_gen.innerHTML = `<i class="fas fa-star"></i>8.5
        <span> Action / Sci-Fi</span>`;
        header_title.innerText = "Aquaman and the Lost Kingdom";
        header_pra.innerText = "Black Manta seeks revenge on Aquaman for his father's death. Wielding the Black Trident's power, he becomes a formidable foe. To defend Atlantis, Aquaman forges an alliance with his imprisoned brother. They must protect the kingdom.";
        slider_btn[0].style.background = "rgb(184, 184, 184, .1)";
        slider_btn[1].style.background = "#fff";
        slider_btn[2].style.background = "rgb(184, 184, 184, .1)";
    }, 5000);
    setTimeout(() => {
        header.style.background = "url('img/salaar-ceasefire.jpg') no-repeat center center/cover";
        header_dur.innerText = "2h 10min";
        header_gen.innerHTML = `<i class="fas fa-star"></i>9.2
        <span>Comady / Action / Drama</span>`;
        header_title.innerText = "salaar-ceasefire";
        header_pra.innerText = "Salaar was theatrically released on 22 December 2023 in standard and IMAX formats to a generally mixed-to-positive reception from critics. It was a hit at the box office, earning over ₹715 crore on a ₹270 crore budget, making it the highest-grossing Telugu film of 2023, third highest-grossing Telugu film of all time and 11th highest-grossing Indian film of all time.[5][6]";
        slider_btn[0].style.background = "rgb(184, 184, 184, .1)";
        slider_btn[1].style.background = "rgb(184, 184, 184, .1)";
...
video_1[0].addEventListener('click', () => {
    ...
    videos.play();
    title_video[0].innerText = "Aquaman";
    plays.classList.add('bi-pause-fill');
    plays.classList.remove('bi-play-fill');
});
video_1[1].addEventListener('click', () => {
    ...
    videos.play();
    title_video[0].innerText = "Oppenhimmer";
    plays.classList.add('bi-pause-fill');
    plays.classList.remove('bi-play-fill');
});
...
const movies = [
    {
        id: 37,
        img: "mimg/openhimmer.jpg",
        down_img: "mimg/openhimmer",
        title: "Openhimmer",
        letter: "o",
        genre1: "action",
        genre2: "none",
